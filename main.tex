...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Patch.png}
...
\begin{figure}[h]
    \centering 
    \includegraphics[width=0.7\linewidth]{axis_of_rotation_center.jpeg}
...
\begin{figure}[h]
    \centering 
    \includegraphics[width=0.7\linewidth]{top_profile.jpeg}
    \includegraphics[width=0.7\linewidth]{side_profile.jpeg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{FloatSatSchematic}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{condition_number_vs_tilt.png}
    \includegraphics[width=0.7\linewidth]{singular_values_vs_tilt.png}
